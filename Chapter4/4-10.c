// Exercise 4-10
/* An alternative organization uses getline to read an input line;
...
size_t linecapp = MAXOP * sizeof(char);	/* maximum line length */
